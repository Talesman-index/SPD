...
const StickyBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full h-[44px] bg-indigo-950 z-[998] flex items-center px-6 overflow-hidden border-t border-white/5">
      ...
      <div className="flex-1 overflow-hidden flex items-center relative">
        <div className="flex whitespace-nowrap animate-ticker">
          <div className="flex items-center gap-4">
            <span className="text-white/60 text-[11px] font-black tracking-[0.1em] uppercase">
      ...
      <a 
        href="#get-started" 
        className="flex-shrink-0 ml-4 px-5 py-1.5 bg-white text-indigo-950 text-[11px] font-black uppercase tracking-widest rounded-full hover:bg-petri-500 hover:text-white transition-all duration-300 whitespace-nowrap shadow-lg"
      >
        Order Now ↗
      </a>
    </div>
